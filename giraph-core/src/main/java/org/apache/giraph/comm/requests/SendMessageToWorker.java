...
public class SendMessageToWorker extends WritableRequest
   ...
   */
  public SendMessageToWorker(Writable message) {
    this.message = message;
  }

  @Override
  public RequestType getType() {
    return RequestType.SEND_MESSAGE_TO_WORKER_REQUEST;
  }
  ...
  void readFieldsRequest(DataInput input) throws IOException {
    ...
    try {
      ...
      throw new IllegalStateException("readFieldsRequest: Exception occurred",
          e);
    }
  }
  ...
  public void doRequest(
    ...
    serverData.getIncomingWorkerMessages().add(message);
  }
}
